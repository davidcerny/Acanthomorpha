...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-operators.txt"), sep = '\n')
```
...
```{r, echo=FALSE}
options(scipen=999)
chunkess <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-LogAnalyser-output.txt", header=TRUE)
chunkess[,c(1,4,7)]
```
...
![Comparison with the MCMCTree-generated tree from the manuscript](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/BEAST-manuscript-tree-comparison.png)
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-crlc-operators.txt"), sep = '\n')
```
...
```{r, echo=FALSE}
options(scipen=999)
chunkcrlc <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-crlc-LogAnalyser-output.txt", header=TRUE)
chunkcrlc[,c(1,4,7)]
```
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-urlc-operators.txt"), sep = '\n')
```
...
```{r, echo = FALSE}
aipichthys <- (143.0 - 98.0)/qexp(0.95)
paste("Aipichthys", aipichthys, sep = " = ")
archaeotetraodon <- (58.5 - 32.02)/qexp(0.95)
paste("Archaeotetraodon", archaeotetraodon, sep = " = ")
archaeus <- (80.8 - 54.17)/qexp(0.95)
paste("Archaeus", archaeus, sep = " = ")
berybolcensis <- (93.7 - 49.0)/qexp(0.95)
paste("Berybolcensis", berybolcensis, sep = " = ")
calatomus <- (63.3 - 11.9)/qexp(0.95)
paste("Calatomus", calatomus, sep = " = ")
chaetodontidae <- (66.0 - 29.62)/qexp(0.95)
paste("Chaetodontidae", chaetodontidae, sep = " = ")
cretzeus <- (111.3 - 69.71)/qexp(0.95)
paste("Cretzeus", cretzeus, sep = " = ")
eastmanalepes <- (69.3 - 49.0)/qexp(0.95)
paste("Eastmanalepes", eastmanalepes, sep = " = ")
eobothus <- (79.7 - 49.0)/qexp(0.95)
paste("Eobothus", eobothus, sep = " = ")
eobuglossus <- (66.6 - 41.2)/qexp(0.95)
paste("Eobuglossus", eobuglossus, sep = " = ")
eucoelopoma <- (94.2 - 54.17)/qexp(0.95)
paste("Eocoelopoma", eucoelopoma, sep = " = ")
gasterorhamphosus <- (111.3 - 69.71)/qexp(0.95)
paste("Gasterorhamphosus", gasterorhamphosus, sep = " = ")
homonotichthys <- (116.35 - 93.9)/qexp(0.95)
paste("Homonotichthys", homonotichthys, sep = " = ")
hoplopteryx <- (128.0 - 93.9)/qexp(0.95)
paste("Hoplopteryx", hoplopteryx, sep = " = ")
luvarus <- (80.8 - 54.17)/qexp(0.95)
paste("Luvarus", luvarus, sep = " = ")
mahengechromis <- (67.4 - 45.46)/qexp(0.95)
paste("Mahengechromis", mahengechromis, sep = " = ")
massamorichthys <- (109.6 - 58.551)/qexp(0.95)
paste("Massamorichthys", massamorichthys, sep = " = ")
mene <- (94.6 - 55.2)/qexp(0.95)
paste("Mene", mene, sep = " = ")
proacanthurus <- (69.3 - 49.0)/qexp(0.95)
paste("Proacanthurus", proacanthurus, sep = " = ")
prosolenostomus <- (93.7 - 49.0)/qexp(0.95)
paste("Prosolenostomus", prosolenostomus, sep = " = ")
rhamphexocoetus <- (79.7 - 49.0)/qexp(0.95)
paste("Rhamphexocoetus", rhamphexocoetus, sep = " = ")
rhinocephalus <- (94.4 - 53.7)/qexp(0.95)
paste("Rhinocephalus", rhinocephalus, sep = " = ")
sphyraena <- (79.7 - 49.0)/qexp(0.95)
paste("Sphyraena", sphyraena, sep = " = ")
tarkus <- (61.6 - 49.0)/qexp(0.95)
paste("Tarkus", tarkus, sep = " = ")
trachipterus <- (94.0 - 5.33)/qexp(0.95)
paste("Trachipterus", trachipterus, sep = " = ")
triodon <- (69.6 - 50.5)/qexp(0.95)
paste("Triodon", triodon, sep = " = ")
turkmene <- (122.5 - 54.17)/qexp(0.95)
paste("Turkmene", turkmene, sep = " = ")
zenopsis <- (91.4 - 32.02)/qexp(0.95)
paste("Zenopsis", zenopsis, sep = " = ")
```
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-ext-operators.txt"), sep = '\n')
```
...
```{r, echo=FALSE}
options(scipen=999)
chunkextess <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-ext1-LogAnalyser-output.txt", header=TRUE)
chunkextess[,c(1,4,7)]
```
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-ext2-operators.txt"), sep = '\n')
```
...
```{r, echo=FALSE}
options(scipen=999)
chunkextess <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/concatchunks-ext-combined-LogAnalyser-output.txt", header=TRUE)
chunkextess[,c(1,4,7)]
```
...
![BEAST under the extended calibration set: first run only vs. combined run](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/beast-ext_first-vs-combined-run.png)

![Comparison of the BEAST analyses under the uncorrelated lognormal clock and 12/28 calibrations with the manuscript tree](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/BEAST-uncorr-12-vs-28.png)
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/fixed-local-strict-13-calib-operators.txt"), sep = '\n')
```
...
```{r, echo=FALSE}
options(scipen=999)
fixed13ess <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/fixed-local-strict-13-calib-LogAnalyser-output.txt", header=TRUE)
fixed13ess[,c(1,4,7)]
```
...
![Comparison between the preliminary and final fixed local clock trees (13 calibrations)](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/fixed-local-strict-13-calib_preliminary-vs-final.png)
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/fixed-local-strict-29-calib-operators.txt"), sep = '\n')
```
...
```{r, echo=FALSE}
options(scipen=999)
fixed29ess <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/fixed-local-strict-29-calib-LogAnalyser-output.txt", header=TRUE)
fixed29ess[,c(1,4,7)]
```
...
![Comparison between the preliminary and final fixed local clock trees (29 calibrations)](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/fixed-local-strict-29-calib_preliminary-vs-final.png)

![Comparison of the BEAST analyses under the fixed local clocks and 12/28 calibrations with the manuscript tree](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/BEAST-fixed-local-12-vs-28.png)
...
![Comparison with the MCMCTree analysis of the same dataset and with the manuscript tree (based on an MCMCTree analysis of the 4-partition dataset)](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/BEAST-MCMCTree-manuscript-tree-comparison.png)
...
![MCMCTree with the extended calibration set and uncorrelated rates vs. the manuscript tree](/Users/David/Grive/Alfaro_Lab/PAML_mcmcTREE/Chunks/sortadate-ext-uncorr_vs_manuscript.png)
...
![MCMCTree with aucorrelated rates vs. the manuscript tree](/Users/David/Grive/Alfaro_Lab/PAML_mcmcTREE/Chunks/sortadate-autocorr_vs_manuscript.png)
...
![MCMCTree with the extended calibration set and autocorrelated rates vs. the manuscript tree](/Users/David/Grive/Alfaro_Lab/PAML_mcmcTREE/Chunks/sortadate-ext-autocorr_vs_manuscript.png)
...
![Comparisons of the PhyloBayes, MCMCTree, and BEAST analyses of the SortaDate alignment under the 12-calibration set with the manuscript tree](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/PhyloBayes/12cal-comparison.png)

![Comparisons of the PhyloBayes, MCMCTree, and BEAST analyses of the SortaDate alignment under the 28-calibration set with the manuscript tree](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/PhyloBayes/28cal-comparison.png)
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/12-fossil-tip-dating-operators.txt"), sep = '\n')
```
...
![BEAST2 tip dating tree based on 12 calibrations](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/12-fossil-tip-dating.png)
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/28-fossil-tip-dating-operators.txt"), sep = '\n')
```
...
![BEAST2 tip dating tree based on 28 calibrations](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/28-fossil-tip-dating.png)
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/12-fossil-tip-dating-unif-root-prior-operators.txt"), sep = '\n')
```

```{r, echo=FALSE}
options(scipen=999)
tipdating12urp <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/12-fossil-tip-dating-unif-root-prior-LogAnalyser-output.txt", header=TRUE)
tipdating12urp[,c(1,4,7)]
```
...
![BEAST2 tip dating tree based on 12 calibrations and a uniform root prior](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/12-fossil-tip-dating-unif-root-prior.png)
...
```{r comment='', echo = FALSE, message=F, warning=F, eval = FALSE}
# Operator analysis results:
cat(readLines("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/28-fossil-tip-dating-unif-root-prior-operators.txt"), sep = '\n')
```

```{r, echo=FALSE}
options(scipen=999)
tipdating12urp <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/28-fossil-tip-dating-unif-root-prior-LogAnalyser-output.txt", header=TRUE)
tipdating12urp[,c(1,4,7)]
```
...
![BEAST2 tip dating tree based on 12 calibrations and a uniform root prior](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/28-fossil-tip-dating-unif-root-prior.png)
...
```{r, echo=FALSE}
tipdating12prior <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/12-tipdating-prior.log", header = TRUE, stringsAsFactors = FALSE)
paste("Prior mean of the 12-fossil tip-dating prior sample:", mean(tipdating12prior[,4]), sep = " ")
paste("Posterior mean of the 12-fossil tip-dating prior sample:", mean(tipdating12prior[,2]), sep = " ")
tipdating28prior <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/28-tipdating-prior.log", header = TRUE, stringsAsFactors = FALSE)
paste("Prior mean of the 28-fossil tip-dating prior sample:", mean(tipdating28prior[,4]), sep = " ")
paste("Posterior mean of the 28-fossil tip-dating prior sample:", mean(tipdating28prior[,2]), sep = " ")
```
...
```{r, echo=FALSE}
ucldnodedatingprior <- read.table("/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/BEAST-uncorr-lognorm-12-calib-prior.log", header = TRUE, stringsAsFactors = FALSE)
paste("Prior mean of the UCLD node-dating prior sample:", mean(ucldnodedatingprior[,3]), sep = " ")
paste("Posterior mean of the UCLD node-dating prior sample:", mean(ucldnodedatingprior[,2]), sep = " ")
```
...
![UCLD node-dating BEAST analysis: comparison of the user-specified (blue) and induced (green) prior](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/BEAST-UCLD-12-calib_user-vs-induced-prior.png)

![UCLD node-dating BEAST analysis: comparison of the user-specified priors (blue) and the posterior (red)](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/BEAST-UCLD-12-calib_user-prior-vs-posterior.png)

![UCLD node-dating BEAST analysis: comparison of the induced prior (green) and the posterior (red)](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/BEAST-UCLD-12-calib_induced-prior-vs-posterior.png)

![BEAST2 12-fossil tip-dating analysis: comparison of the induced prior (blue) and the posterior (red)](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/12-fossil-tip-dating_prior-vs-posterior.png)

![BEAST2 28-fossil tip-dating analysis: comparison of the induced prior (blue) and the posterior (red)](/Users/David/Grive/Alfaro_Lab/Acanthomorpha/sate-gblocks-clean-min-90-taxa/Concat/Tip_dating/28-fossil-tip-dating_prior-vs-posterior.png)
