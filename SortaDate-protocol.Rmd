...
hist(l$root_to_tip_var, breaks = 5000, xlim=c(0,2), xlab = "Root-to-tip variance", col="greenyellow", main="Histogram of root-to-tip variance\n(all chunks, excluding outliers)")
hist(l$treelength, xlab = "Tree length", col="lightcoral", main="Histogram of tree length (all chunks)")
```
...
# 50-bp chunks from the 90-locus dataset
...
## 50-bp chunks from the 90-locus dataset: SH-like of 75% or above
...
## 50-bp chunks from the 90-locus dataset: SH-like of 90% or above
